...
let properties = [
	...
	['Subheading Wikipedia Style', 1, 'wikiStyle'],
	...
	['Text Reader 1 Item (field or full path)', '$if2(%lyrics%,%syncedlyrics%)', 'pthTxtReader0'],
	['Text Reader 2 Item (field or full path)', '%profile%\\lyrics\\%BIO_ARTIST% - %BIO_TITLE%.lrc', 'pthTxtReader1'],
	['Text Reader 3 Item (field or full path)', '$if2(%unsynced lyrics%,%unsyncedlyrics%)', 'pthTxtReader2'],
	['Text Reader 4 Item (field or full path)', '%storage_folder%\\nowplaying.txt', 'pthTxtReader3'],
	['Text Reader 5 Item (field or full path)', '$if2(%lyrics%,%syncedlyrics%)', 'pthTxtReader4'],
	['Text Reader 6 Item (field or full path)', '%profile%\\lyrics\\%BIO_ARTIST% - %BIO_TITLE%.lrc', 'pthTxtReader5'],
	['Text Reader 7 Item (field or full path)', '$if2(%unsynced lyrics%,%unsyncedlyrics%)', 'pthTxtReader6'],
