...
安装 foobox 到 foobar2000 前您应该已安装有 foobar2000 播放器 (x86 汉化版).$\n$\n\
...
Section "增强的频谱可视化面板" Spectrum
	...
	File ".\cn\x86\optional-components\foo_enhanced_spectrum_analyzer\foo_enhanced_spectrum_analyzer.dll"
	SetOutPath "$INSTDIR\themes"
	File ".\cn\x86\themes-vis\*.*"
SectionEnd
