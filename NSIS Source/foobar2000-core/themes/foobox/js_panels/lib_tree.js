...
function populate() {
	...
	this.lbtn_dn = function(x, y) {
		...
		case 0:
			...
			break;
		case 1:
			if (v.k(2) && sgl_fill) return this.add(x, y);
			if (!v.k(1)) this.clear();
...
function getview(initial, separt) {
	if(initial){
		...
		if(separt){
			window.SetProperty(" View 01: Name // Pattern", "按艺术家 // %<artist>%|%album%|[[%discnumber%.]%tracknumber%. ][%track artist% - ]%title%");
			window.SetProperty(" View 02: Name // Pattern", "按专辑艺术家 // %<album artist>%|%album%|[[%discnumber%.]%tracknumber%. ][%track artist% - ]%title%");
			window.SetProperty(" View 03: Name // Pattern", "按艺术家(简单) // %<artist>%|%title%");
			window.SetProperty(" View 04: Name // Pattern", "按专辑艺术家 - 专辑 // [%<album artist>% - ]%album%|[[%discnumber%.]%tracknumber%. ][%track artist% - ]%title%");
			window.SetProperty(" View 05: Name // Pattern", "按专辑[专辑艺术家] // %album%[ '['%<album artist>%']']|[[%discnumber%.]%tracknumber%. ][%track artist% - ]%title%");
			window.SetProperty(" View 06: Name // Pattern", "按专辑 // %album%|[[%discnumber%.]%tracknumber%. ][%track artist% - ]%title%");
			window.SetProperty(" View 07: Name // Pattern", "按流派 // %<genre>%|[%<album artist>% - ]%album%|[[%discnumber%.]%tracknumber%. ][%track artist% - ]%title%");
			window.SetProperty(" View 08: Name // Pattern", "按年份 // $year($replace(%date%,/,-,.,-))|[%<album artist>% - ]%album%|[[%discnumber%.]%tracknumber%. ][%track artist% - ]%title%");
			window.SetProperty(" View 09: Name // Pattern", "按日期 // %date%|[%<album artist>% - ]%album%|[[%discnumber%.]%tracknumber%. ][%track artist% - ]%title%");
			window.SetProperty(" View 10: Name // Pattern", "按目录名称 // %directory%|[%<album artist>% - ]%album%|[[%discnumber%.]%tracknumber%. ][%track artist% - ]%title%");
		}
		else {
			window.SetProperty(" View 01: Name // Pattern", "按艺术家 // %artist%|%album%|[[%discnumber%.]%tracknumber%. ][%track artist% - ]%title%");
			window.SetProperty(" View 02: Name // Pattern", "按专辑艺术家 // %album artist%|%album%|[[%discnumber%.]%tracknumber%. ][%track artist% - ]%title%");
